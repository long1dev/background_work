...
class BackgroundWorkSolved : Service() {
    ...
    private fun startEngine(rawHandler: Long, path: String) {
        ...
        val pathToBundler = FlutterInjector.instance().flutterLoader().findAppBundlePath()
        val callback = DartExecutor.DartCallback(assets, pathToBundler, info)
